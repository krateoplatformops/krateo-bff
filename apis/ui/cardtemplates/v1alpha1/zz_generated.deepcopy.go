...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EvalCard) DeepCopyInto(out *EvalCard) {
	*out = *in
	out.Card = in.Card
	if in.Actions != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EvalCard.
func (in *EvalCard) DeepCopy() *EvalCard {
	if in == nil {
		return nil
	}
	out := new(EvalCard)
