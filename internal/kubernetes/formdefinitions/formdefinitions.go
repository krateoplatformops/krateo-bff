...
func (c *Client) Get(ctx context.Context, name string) (result *v1alpha1.FormDefinition, err error) {
	result = &v1alpha1.FormDefinition{}
	err = c.rc.Get().
		Namespace(c.ns).
	...
	result.SetGroupVersionKind(v1alpha1.FormDefinitionGroupVersionKind)
	return
}

func (c *Client) List(ctx context.Context, opts metav1.ListOptions) (result *v1alpha1.FormDefinitionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FormDefinitionList{}
	err = c.rc.Get().
		Namespace(c.ns).
		Resource(resourceName).
...
func (c *Client) Create(ctx context.Context, obj *v1alpha1.FormDefinition, opts metav1.CreateOptions) (result *v1alpha1.FormDefinition, err error) {
	result = &v1alpha1.FormDefinition{}
	err = c.rc.Post().
		Namespace(c.ns).
		Resource(resourceName).
...
func (c *Client) Update(ctx context.Context, obj *v1alpha1.FormDefinition, opts metav1.UpdateOptions) (result *v1alpha1.FormDefinition, err error) {
	result = &v1alpha1.FormDefinition{}
	err = c.rc.Put().
		Namespace(c.ns).
		Resource(resourceName).
...
func (c *Client) UpdateStatus(ctx context.Context, obj *v1alpha1.FormDefinition) (result *v1alpha1.FormDefinition, err error) {
	result = &v1alpha1.FormDefinition{}
	err = c.rc.Put().
		Namespace(c.ns).
		Resource(resourceName).
...
func (c *Client) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1alpha1.FormDefinition, err error) {
	result = &v1alpha1.FormDefinition{}
	err = c.rc.Patch(pt).
		Namespace(c.ns).
		Resource(resourceName).
